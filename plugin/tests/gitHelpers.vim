...
" Could export this to python, but using vimscript bc Fugitive is good at finding repo info
" (2018/1/21) I never use this bc I want to have full control in terminal
